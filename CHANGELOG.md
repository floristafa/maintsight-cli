...
All notable changes to the MaintSight will be documented in this file.
...
- **⚠️ Environment Variables No Longer Supported**: Environment variables for API keys and LLM settings are **NO LONGER** used as fallbacks. All configuration must be provided in `.maintsight.config.json`.
